        ...
        public void onEnable() {
                ...
                try {
                        ...
                        com.antigravity.rpg.feature.player.PlayerData.initialize(
                                        ...
                                        injector.getInstance(
                                                        com.antigravity.rpg.feature.classes.condition.ConditionManager.class));
                ...
                try {
                        ...
                        serviceManager.startService(
                                        injector.getInstance(com.antigravity.rpg.data.service.DatabaseService.class));
                        serviceManager.startService(
                                        injector.getInstance(com.antigravity.rpg.core.network.NetworkService.class));
                        ...
                        serviceManager
                                        .startService(injector.getInstance(
                                                        com.antigravity.rpg.feature.player.PlayerProfileService.class));

                        // 아이템 관리 서비스
                        serviceManager.startService(
                                        injector.getInstance(com.antigravity.rpg.feature.item.ItemService.class));

                        // 전투 시스템 서비스
                        serviceManager.startService(
                                        injector.getInstance(com.antigravity.rpg.feature.combat.CombatService.class));

                        // 스킬 시전 서비스
                        serviceManager.startService(
                                        injector.getInstance(com.antigravity.rpg.feature.skill.SkillCastService.class));

                        // UI 서비스
                        serviceManager.startService(
                                        injector.getInstance(com.antigravity.rpg.feature.ui.ActionBarService.class));
                        serviceManager
                                        .startService(injector.getInstance(
                                                        com.antigravity.rpg.feature.ui.DamageIndicatorService.class));
                        ...
                        getServer().getPluginManager().registerEvents(
                                        injector.getInstance(
                                                        com.antigravity.rpg.core.engine.listener.CombatEventListener.class),
                                        this);
                        getServer().getPluginManager().registerEvents(
                                        injector.getInstance(
                                                        com.antigravity.rpg.core.engine.listener.ActionHandler.class),
                                        this);
                        getServer().getPluginManager().registerEvents(
                                        injector.getInstance(
                        ...
                        if (getServer().getPluginManager().isPluginEnabled("MythicMobs")) {
                                getServer().getPluginManager().registerEvents(
                                                injector.getInstance(
                                                                com.antigravity.rpg.core.engine.hook.MythicMobsHook.class),
                                                this);
                        }
                        ...
                        if (getCommand("rpgadmin") != null) {
                                getCommand("rpgadmin")
                                                .setExecutor(new com.antigravity.rpg.command.admin.DataSyncCommand(
                                                                injector.getInstance(
                                                                                com.antigravity.rpg.data.service.DataImportExportService.class),
                                                                injector.getInstance(
                                                                                com.antigravity.rpg.core.script.LuaScriptService.class),
                                                                injector.getInstance(
                                                                                com.antigravity.rpg.feature.skill.SkillManager.class),
                                                                injector.getInstance(
